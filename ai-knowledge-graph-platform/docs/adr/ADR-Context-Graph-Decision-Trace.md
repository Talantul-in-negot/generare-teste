...
Accepted for implementation in Context Graph P0. Schema version:
`context-graph/v1`.
...
runs, manifests, tool observations, alternatives, decisions, and policy
evaluation.
...
`CGCase`, `CGAgentRun`, `CGToolCall`, `CGObservation`,
...
`PRODUCED`, `PRODUCED_DECISION`, `INCLUDED_STATEMENT`, `INCLUDED_CHUNK`,
...
intelligence are deliberately not part of this decision.
