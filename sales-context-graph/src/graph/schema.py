...
CONSTRAINT_STATEMENTS: list[str] = [
    ...
    "CREATE CONSTRAINT extraction_run_workspace_id_unique IF NOT EXISTS FOR (n:ExtractionRun) REQUIRE (n.workspace_id, n.extraction_run_id) IS UNIQUE",
...
ALL_CONSTRAINT_NAMES: list[str] = [
    ...
    "extraction_run_workspace_id_unique",
